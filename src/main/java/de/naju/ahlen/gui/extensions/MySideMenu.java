...
public class MySideMenu extends HorizontalLayout {
    ...
    public void setMenuAreaWidthUndefined() {
        menuArea.setWidthUndefined();
    }

    public void setMenuAreaWidth(String width) {
        menuArea.setWidth(width);
    }

    public void setMenuAreaWidth(float width, Unit unit) {
        menuArea.setWidth(width, unit);
    }
}
